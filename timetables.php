...
$sql = "SELECT * FROM subjects where code='$code' and day='Mon'";
...
if ($result->num_rows > 0) {
	...
	if($cur_day == $row['day']){
		$fac = $row['faculty'];
		$mys = "SELECT * FROM faculty where name='$fac' ";
		$res = $conn->query($mys);
		if ($res->num_rows > 0){
			$date=date('d-m-Y');
			$mys_t = "SELECT * FROM attendence where name='$fac' and date='$date'";
			$res_t = $conn->query($mys_t);
			...
			if($row_t['status'] == 0){
				...
				$sub=$row['subject'];
				$ssub=$row['faculty'];
				echo "<td title='$ssub' style='color:red;'>$sub<br>($st - $et)</td>";
			}
			else{
				$st=$row['start-time'];
				$et=$row['end-time'];
...
$sql = "SELECT * FROM subjects where code='$code' and day='Tue'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
...
$sql = "SELECT * FROM subjects where code='$code' and day='Wed'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
...
$sql = "SELECT * FROM subjects where code='$code' and day='Thu'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
...
$sql = "SELECT * FROM subjects where code='$code' and day='Fri'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
...
$sql = "SELECT * FROM subjects where code='$code' and day='Sat'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
...
$sql = "SELECT * FROM subjects where code='$code' and day='Sun'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
...
<div class="container">
	<div class="row"><form action=timetables.php method=POST>
<input type=text name=code value='.$code.' hidden>
    <button type=submit class="btn btn-primary a-btn-slide-text" name=view>
        <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
        <span><strong>View</strong></span>            
</button>
</form><form action=timetables.php method=POST>
<input type=text name=code value='.$code.' hidden>

    <button type=submit class="btn btn-primary a-btn-slide-text" name=delete>
       <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
        <span><strong>Delete</strong></span>   
    </button>
     <input type=password id=blankbox name=admincode placeholder="'.'enter admin code'.'" Required> 
    </form>
	</div>
</div>
